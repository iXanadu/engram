...
- **GRANT-1** A claim's preferred seat is SILENTLY discarded when R8 parks
  ...
  `projbeta-app-grok` (peer read the live env); that address holds 7 OPEN
  ...
  candidate; base is the reserved lane; grant falls to `projbeta-grok-3`
  ...
  the next claim then gets `projbeta-app-grok` granted.
