...
def _own_project() -> str:
    ...
    `projepsilon-claude-2` mid-huddle, its reply to the room was refused
...
# Projalpha certifies the death of every session it stops (LANE-4), and since
...
async def memory_store(
    ...
    # Measured dropped in the wild (projdelta, 2026-08-10) within hours of the
