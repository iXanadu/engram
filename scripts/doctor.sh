...
#   · 2026-06-27→08-11: TWO launchd jobs owned postgres on hosta (boot daemon
...
# by hand, by cron, or as an Projalpha check_tools.d executable.
#
...
PG_LOGS=("/opt/homebrew/var/log/postgresql@17.log" "/var/log/hosta/postgresql.err")
...
if [ "$(uname)" = "Darwin" ]; then
    daemon_loaded=0
    sudo -n launchctl print system/com.hosta.postgresql >/dev/null 2>&1 && daemon_loaded=1
