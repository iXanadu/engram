...
I1. Manual CLI spawning cannot be prohibited. The sessions spawned manually
    (engram/projalpha/maintenance) are spawned precisely when infrastructure
...
# v2 — POST-REVIEW REVISION (adversarial cut: projalpha-app-grok-2, 2026-08-20 22:47Z)
...
9a806f2 prod restart a session-owned waiter (projalpha-app-grok-2's pid
...
agent — any provider, no Projalpha involved — from getting a mailbox, a
