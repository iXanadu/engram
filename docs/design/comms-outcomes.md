...
*Corollary, agreed: `projalpha-app` becomes its own project. Its cfg drops
...
Final form, from the admin@hostb evidence: the distinction is
...
### Projalpha (work orders from this review)
...
- Timing of the projalpha-app project split (migration: cfg + launcher
